...
bot = telebot.TeleBot('7915334525:AAEgXB13U7sFWv5Kp6gXYXq1ie6vz3CFccI')
...
def show_main_buttons(message):
    ...
    bot.send_message(message.chat.id, "🔹 𝗪𝗘𝗟𝗖𝗢𝗠𝗘 𝗧𝗢 𝗩𝗘𝗡𝗢𝗠 𝗢𝗙𝗙𝗜𝗖𝗜𝗔𝗟 𝗣𝗔𝗜𝗗 𝗗𝗗𝗢𝗦 𝗕𝗢𝗧 🔹", reply_markup=markup)
...
def handle_buy_coins(message):
    ...
    if user_id in admin_id:
        ...
        bot.reply_to(message, "💰 𝗗𝗠 𝗧𝗢 𝗕𝗨𝗬 𝗖𝗢𝗜𝗡𝗦 @TOXICVENOMNO1")
